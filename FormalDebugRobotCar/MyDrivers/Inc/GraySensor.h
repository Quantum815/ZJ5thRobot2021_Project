...
#define GRAYSENSOR_USART3_TX_GPIO_PORT GPIOB
#define GRAYSENSOR_USART3_TX_GPIO_PIN  GPIO_PIN_10
#define GRAYSENSOR_USART3_RX_GPIO_PORT GPIOB
#define GRAYSENSOR_USART3_RX_GPIO_PIN  GPIO_PIN_11
